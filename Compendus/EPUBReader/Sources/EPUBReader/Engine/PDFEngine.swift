...
public class PDFEngine: ReaderEngine {
    ...
    public func load(initialPage: Int? = nil) {
    ...
    public func setPDFView(_ view: PDFView) {
        self.pdfView = view
    }
    ...
    public func saveHighlightFromSelection(color: String, note: String? = nil) -> (text: String, locatorJSON: String, progression: Double, chapterTitle: String)? {
...
@MainActor
public class PDFViewHostController: UIViewController, UIGestureRecognizerDelegate {
    public let engine: PDFEngine
    private var pdfView: PDFView!

    public init(engine: PDFEngine) {
        self.engine = engine
