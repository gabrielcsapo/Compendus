...
public struct PlainTextToAttrStringMap {
    public struct Entry {
        public let plainTextRange: NSRange
        public let attrStringRange: NSRange
    }
    ...
    public func attrStringRange(for plainTextRange: NSRange) -> NSRange? {
    ...
    public func plainTextOffset(forAttrStringLocation location: Int) -> Int? {
    ...
    public func plainTextLocation(forAttrStringLocation location: Int) -> Int? {
        if let entry = entries.first(where: {
            NSLocationInRange(location, $0.attrStringRange)
        }) {
...
public class TextAlignmentEngine {
    ...
    public struct AlignmentResult {
        ...
        public let lastMatchedCursorPosition: Int
    }
