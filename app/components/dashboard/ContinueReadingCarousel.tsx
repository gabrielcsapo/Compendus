        ...
        <div className="relative group/carousel">
          ...
          >
            {books.map((book) => {
              ...
              // Reflowable books read through CCD. If a re-conversion is in flight or
              // failed, route to the detail page (which shows the gated state/message)
              // instead of dropping the user into a blank reader.
              ...
              return (
                ...
                >
                  <Link
                    to={ccdReady ? `/book/${book.id}/read` : `/book/${book.id}`}
                  ...
                  >
                    ...
                    >
                      ...
                      {/* Progress label badge — or CCD-readiness state when not ready */}
