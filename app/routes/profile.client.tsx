...
const EMOJI_SUGGESTIONS = [
  ...
  "\u{1F9D1}\u{200D}\u{1F4BB}", "\u{1F436}", "\u{1F33B}", "\u{26A1}",
];
    ...
    <main className="container mx-auto px-6 py-12 max-w-xl">
      ...
      <div className="bg-surface border border-border rounded-xl divide-y divide-border">
        ...
        <div className="px-5 py-4 flex items-center justify-between">
          ...
          <span className={profile.isAdmin ? `${badgeStyles.base} ${badgeStyles.warning}` : "text-sm text-foreground"}>
      ...
      <div className="mt-6 flex flex-col gap-3">
        <Link
          to="/profiles"
          className={`${buttonStyles.base} ${buttonStyles.ghost} w-full`}
        >
          <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
